...
var Posts_default = [
  ...
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 30 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 45 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 60 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 75 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 90 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 105 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 120 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 135 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 150 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 165 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  {
    ...
    timestamp: Date.now() - 5 * 24 * 60 * 60 * 1e3 + 180 * 60 * 1e3,
    type: "profile",
    parentId: "20"
  },
  ...
  searchSubjects(query) {
    return new Promise((resolve) => {
      setTimeout(() => {
        ...
        if (query.trim()) {
          results = results.filter(
            (subject) => subject.name.toLowerCase().includes(query.toLowerCase()) || subject.description.toLowerCase().includes(query.toLowerCase())
          );
        }
        resolve(results);
      }, 150);
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-5ZPPOQ6L.js.map
